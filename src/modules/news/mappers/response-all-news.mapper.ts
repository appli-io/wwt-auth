...
import { ResponseNewsCategoryMapper } from '@modules/news/mappers/response-news-category.mapper';
...
export class ResponseAllNewsMapper implements Partial<INews> {
  ...
  public category: ResponseNewsCategoryMapper;
  ...
  public static map(news: NewsEntity): ResponseAllNewsMapper {
    return new ResponseAllNewsMapper({
      ...
      category: ResponseNewsCategoryMapper.map(news.category),
