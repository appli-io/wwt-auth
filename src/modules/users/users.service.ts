import { BadRequestException, ConflictException, Injectable, Logger, LoggerService, UnauthorizedException } from '@nestjs/common';
...
import { ChangeEmailDto } from '@/modules/users/dtos/change-email.dto';
...
export class UsersService {
  ...
  constructor( @InjectRepository(UserEntity) private readonly usersRepository: EntityRepository<UserEntity>,
